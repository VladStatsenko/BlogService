...
public class OnePostResponse extends PostBody {
    ...
    public OnePostResponse(int id, long timestamp, UserBody user, String title, String announce, int likeCount, int dislikeCount, int commentCount, int viewCount, List<CommentBody> comments, List<String> tags) {
